      ...
      <tbody><tr>
        <td width="22%"><table border="0" align="center" width="185">
          <tbody><tr bgcolor="#EFF7FC">
                  ...
                  <td class="aalpha" bgcolor="#FFFFFF" height="19"><div align="center"><marquee width="105%" direction="right" height="150px"><img src="corier.jpg" height="155" width="170"></marquee> </div></td>
				  </tr>
				  <tr>
				   <td class="aalpha" bgcolor="#FFFFFF" height="19"><div align="center"><marquee width="105%" direction="left" height="150px"><img src="corier1.jpg" height="150" width="170"></marquee> </div></td>
                </tr>
        ...
        <td class="aalpha" width="54%"><p class="navi" align="justify" ><font size="3" style="Times New Roman">
		<strong>Courier Service </strong> means any services provided to a customer, by a courier agency in relation to door-to-door transportation of time sensitive documents, goods or articles. <strong> </strong></p>
...
domestic shipping. </p> </br></br>

 <a href="contact.php" target="_self">Contact-us</a> 
               <br/>
		   <lable> courservices@gmail.com </lable>

          <p class="navi" align="justify"> <strong></strong></p>
         </td>
